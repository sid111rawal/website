          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-lg text-muted-foreground mb-6">
                I'm Sid Rawal, a web developer and digital marketer with over 5 years of experience helping businesses establish and grow their online presence. I combine technical expertise with strategic marketing to create websites and campaigns that drive real results.
              </p>
              <p className="text-lg text-muted-foreground mb-6">
                As the founder of <span className="font-semibold text-primary">goBusy</span>, I've built a company focused on delivering comprehensive digital solutions. From custom website development to full-scale digital marketing campaigns, I help businesses stand out in the digital landscape.
              </p>
              <p className="text-lg text-muted-foreground mb-8">
                My approach is simple: create beautiful, functional websites that convert visitors into customers, and develop marketing strategies that generate qualified leads. Whether it's building a responsive website, managing social media campaigns, or creating engaging video content, I deliver solutions that help businesses achieve their goals.
              </p>
